...
const Footer = () => {
  return (
    <footer className="footer bg-[#313335] text-base-content flex flex-col py-10">
      {/* Contact Section */}
      <div className="flex flex-col md:flex-row justify-between items-center mt-5 w-10/12 mx-auto gap-6">
        <div className="flex items-center gap-4">
          <div className="h-12 w-12 bg-[#bb0d21] flex justify-center items-center text-white">
            <FaMapMarkerAlt />
          </div>
          <div>
      ...
      <div className="w-10/12 mx-auto flex flex-col md:flex-row justify-between items-center text-white gap-5 ">
